...
<body>
	...
	<div class="nav">
		...
		<c:forEach var="theloai" items="${category}">

			<div class="nav-item">
				<a href="">${theloai.getName()}</a>
				<div class="nav-itemlist">
					<ul>
					<c:forEach var="values" items="${theloai.getValues()}">
				...
				<div class="col-lg-2">
					<div class="list-group border">
						<span style="font-size: 20px; font-weight: bold; color: #9F224E">Xu
							...
							class="text-danger" style="font-size: 18px; font-weight: bold;">Một
								chiều</span> / Thời đại mạng xã hội, giáo viên ngày càng sợ phụ huynh
						</a> <a href="#" class="list-group-item"> <span
							class="text-danger" style="font-size: 18px; font-weight: bold;">Nhận
								con nuôi</span> / Bà mẹ Mỹ nuôi hai đứa trẻ mồ côi song sinh người Việt
						</a> <a href="#" class="list-group-item"> <span
							class="text-danger" style="font-size: 18px; font-weight: bold;">Nhu
								cầu tăng</span> / Giá gạo tăng cao kỷ lục
						</a> <a href="#" class="list-group-item"> <span
							class="text-danger" style="font-size: 18px; font-weight: bold;">Chuyển
								mình</span> / Tân Hòa: Vươn lên từ nông thôn khó khăn đến du lịch xuất
							sắc
						</a>
					</div>
						...
						<div class="col-lg-12 col-md-6 mb-4">
							<div class="card h-200" style="width: 100%;">
								<div class="row no-gutters">
									...
									<div class="col-md-4">
										<div class="card-body">
											<h5 class="card-title">Public bike service draws users
												in Hanoi</h5>
											<p class="card-text">More than 100,000 people have
												registered to use Hanoi's public bicycle-sharing service,
												and around 135,000 rides have been made after two months.</p>
										</div>
									</div>
								</div>
							</div>
